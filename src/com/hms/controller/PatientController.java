...
public class PatientController {
	...
	public String chooseMenuOption(@RequestParam("patientChoice") String patientChoice,HttpServletRequest request,ModelMap map)
	{
		...
		case "mySchedules":
			List<Schedule> patientSchedule = patientService.patientSchedule((int)session.getAttribute("patientId"));
			map.addAttribute("patientSchedule", patientSchedule);
